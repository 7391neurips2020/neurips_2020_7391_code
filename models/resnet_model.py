...
def resnet(features, labels, is_training=True, resnet_depth=50, 
           num_classes=1000, data_format='channels_last',
  ...
  #dropblock_keep_probs = [0.75]*4
  #dropblock_size=1
  network = resnet_generator(
