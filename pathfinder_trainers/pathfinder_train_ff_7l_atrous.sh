...
python main_estimator_pathfinder.py -b 128 -ne 10 -lr 5e-4 -tr 1 -ob bce -op adam -en pathfinder_khw5_curv9_fastnips_ff_7l_atrous_adam_100k -v1 ff_7l_atrous -tpu 1 -tpu-name $1 -eval-freq 1 -len 9 -kp 0.5 -ckpt gs://ADD_BUCKET_NAME_HERE/open_close_tfrecords/output_dir_neuripsrun_marked_len16_ff_7l_atrous_adam_400k_2020_05_07_23_49_40 -ft-dense True
