...
class openclose_dataloader(object):
    def __init__(self, batch_size, file_pattern, training=True, image_size=256):
    ...
    def read_tf_records(self,
        ...
        dataset = dataset.shuffle(
                  buffer_size=10000, reshuffle_each_iteration=True).repeat()
